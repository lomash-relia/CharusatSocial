...
import 'package:charusatsocial/AuthenticationScreen/components/forget_password_page.dart';
import 'package:charusatsocial/AuthenticationScreen/components/signup_page.dart';
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomFormButton(innerText: 'Login', onPressed: ()=> Navigator.push(context, MaterialPageRoute(builder: (context) => const MainScreen())),),
